...
Output: database2_columns_selected.xlsx
"""
...
input_path  = os.path.join(output_folder, "database2_required_fields_ok.xlsx")
output_path = os.path.join(output_folder, "database2_columns_selected.xlsx")
...
# "Time Sited" is stored as a string ("14:08"), no datetime conversion needed
