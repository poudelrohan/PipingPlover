...
Uses a generous rectangle that covers the Gulf coast, Keys, and barrier islands.
...
Output: database2_geo_validated.xlsx
"""
...
input_path   = os.path.join(output_folder, "database2_with_ids.xlsx")
output_path  = os.path.join(output_folder, "database2_geo_validated.xlsx")
...
# negate latitude. Try correcting and check if the point falls inside the box.
corrections = []
