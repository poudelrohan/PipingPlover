...
──────────────────────
Reads the eBird Excel file, loads only the data sheet (Sheet1 is empty),
and adds:
...
Output: database1_with_ids.xlsx
"""
...
# ── Save output ────────────────────────────────────────────────────────────────
output_path = os.path.join(output_folder, "database1_with_ids.xlsx")
